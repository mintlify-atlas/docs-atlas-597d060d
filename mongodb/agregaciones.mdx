---
title: "Agregaciones en MongoDB con $match, $group y $lookup"
sidebarTitle: "Agregaciones"
description: "Aprende a usar el pipeline de agregación de MongoDB con $match, $group, $sort, $project, $limit, $lookup y $unwind para consultas avanzadas."
---
