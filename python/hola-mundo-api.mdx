---
title: "Crear una API Hola Mundo con Flask y Python"
sidebarTitle: "API Hola Mundo"
description: "Construye tu primera API REST con Flask en Python. Crea endpoints GET, instala Flask-CORS y entiende la estructura de Blueprints."
---
